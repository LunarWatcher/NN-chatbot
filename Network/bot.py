...
if __name__ == '__main__':
    ...
    parser.add_argument("--mode", help="(When training = false only) Where to boot the bot. 0 is the console, 1 is online, 2 is online with Java/Kotlin. More modes may come eventually")
    ...
    mode = 0
    if not training:
        mode = getIntInput("Mode: ", [0, 1, 2]) if modeArg is None else int(modeArg)
